...
func init() {
	...
	typemap.RegisterMessage("px4_msgs/msg/GimbalDeviceSetAttitude", GimbalDeviceSetAttitudeTypeSupport)
}
...
func GimbalDeviceSetAttitude__Sequence_to_C(cSlice *CGimbalDeviceSetAttitude__Sequence, goSlice []GimbalDeviceSetAttitude) {
	...
	cSlice.data = (*C.px4_msgs__msg__GimbalDeviceSetAttitude)(C.malloc(C.sizeof_struct_px4_msgs__msg__GimbalDeviceSetAttitude * C.size_t(len(goSlice))))
