...
func init() {
	typemap.RegisterMessage("px4_msgs/GimbalDeviceInformation", GimbalDeviceInformationTypeSupport)
	typemap.RegisterMessage("px4_msgs/msg/GimbalDeviceInformation", GimbalDeviceInformationTypeSupport)
}
...
func (t _GimbalDeviceInformationTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Uint8__Array_to_C(*(*[]primitives.CUint8)(unsafe.Pointer(&cSlice_vendor_name)), m.VendorName[:])
	cSlice_model_name := mem.model_name[:]
	primitives.Uint8__Array_to_C(*(*[]primitives.CUint8)(unsafe.Pointer(&cSlice_model_name)), m.ModelName[:])
	cSlice_custom_name := mem.custom_name[:]
	primitives.Uint8__Array_to_C(*(*[]primitives.CUint8)(unsafe.Pointer(&cSlice_custom_name)), m.CustomName[:])
...
func (t _GimbalDeviceInformationTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	cSlice_vendor_name := mem.vendor_name[:]
	primitives.Uint8__Array_to_Go(m.VendorName[:], *(*[]primitives.CUint8)(unsafe.Pointer(&cSlice_vendor_name)))
	cSlice_model_name := mem.model_name[:]
	primitives.Uint8__Array_to_Go(m.ModelName[:], *(*[]primitives.CUint8)(unsafe.Pointer(&cSlice_model_name)))
	cSlice_custom_name := mem.custom_name[:]
	primitives.Uint8__Array_to_Go(m.CustomName[:], *(*[]primitives.CUint8)(unsafe.Pointer(&cSlice_custom_name)))
...
func GimbalDeviceInformation__Sequence_to_C(cSlice *CGimbalDeviceInformation__Sequence, goSlice []GimbalDeviceInformation) {
	...
	cSlice.data = (*C.px4_msgs__msg__GimbalDeviceInformation)(C.malloc(C.sizeof_struct_px4_msgs__msg__GimbalDeviceInformation * C.size_t(len(goSlice))))
