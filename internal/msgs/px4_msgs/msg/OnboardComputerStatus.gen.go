...
func init() {
	typemap.RegisterMessage("px4_msgs/OnboardComputerStatus", OnboardComputerStatusTypeSupport)
	typemap.RegisterMessage("px4_msgs/msg/OnboardComputerStatus", OnboardComputerStatusTypeSupport)
}
...
type OnboardComputerStatus struct {
	...
	Uptime           uint32    `yaml:"uptime"`            // [ms] time since system boot of the companion (milliseconds)
...
func OnboardComputerStatus__Sequence_to_C(cSlice *COnboardComputerStatus__Sequence, goSlice []OnboardComputerStatus) {
	...
	cSlice.data = (*C.px4_msgs__msg__OnboardComputerStatus)(C.malloc(C.sizeof_struct_px4_msgs__msg__OnboardComputerStatus * C.size_t(len(goSlice))))
