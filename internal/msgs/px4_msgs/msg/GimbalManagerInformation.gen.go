...
func init() {
	...
	typemap.RegisterMessage("px4_msgs/msg/GimbalManagerInformation", GimbalManagerInformationTypeSupport)
}
...
func GimbalManagerInformation__Sequence_to_C(cSlice *CGimbalManagerInformation__Sequence, goSlice []GimbalManagerInformation) {
	...
	cSlice.data = (*C.px4_msgs__msg__GimbalManagerInformation)(C.malloc(C.sizeof_struct_px4_msgs__msg__GimbalManagerInformation * C.size_t(len(goSlice))))
