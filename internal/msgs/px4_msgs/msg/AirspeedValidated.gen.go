...
func init() {
	...
	typemap.RegisterMessage("px4_msgs/msg/AirspeedValidated", AirspeedValidatedTypeSupport)
}
...
type AirspeedValidated struct {
	...
	AirspeedDerivativeFiltered     float32 `yaml:"airspeed_derivative_filtered"`      // filtered indicated airspeed derivative [m/s/s]
	ThrottleFiltered               float32 `yaml:"throttle_filtered"`                 // filtered fixed-wing throttle [-]
	PitchFiltered                  float32 `yaml:"pitch_filtered"`                    // filtered pitch [rad]
}
...
func (t *AirspeedValidated) Clone() *AirspeedValidated {
	...
	c.AirspeedDerivativeFiltered = t.AirspeedDerivativeFiltered
	c.ThrottleFiltered = t.ThrottleFiltered
	c.PitchFiltered = t.PitchFiltered
	return c
}
...
func (t *AirspeedValidated) SetDefaults() {
	...
	t.AirspeedDerivativeFiltered = 0
	t.ThrottleFiltered = 0
	t.PitchFiltered = 0
}

func (t *AirspeedValidated) GetTypeSupport() types.MessageTypeSupport {
	return AirspeedValidatedTypeSupport
}

// AirspeedValidatedPublisher wraps rclgo.Publisher to provide type safe helper
// functions
type AirspeedValidatedPublisher struct {
	*rclgo.Publisher
}

// NewAirspeedValidatedPublisher creates and returns a new publisher for the
// AirspeedValidated
func NewAirspeedValidatedPublisher(node *rclgo.Node, topic_name string, options *rclgo.PublisherOptions) (*AirspeedValidatedPublisher, error) {
	pub, err := node.NewPublisher(topic_name, AirspeedValidatedTypeSupport, options)
	if err != nil {
		return nil, err
	}
	return &AirspeedValidatedPublisher{pub}, nil
}

func (p *AirspeedValidatedPublisher) Publish(msg *AirspeedValidated) error {
	return p.Publisher.Publish(msg)
}

// AirspeedValidatedSubscription wraps rclgo.Subscription to provide type safe helper
// functions
type AirspeedValidatedSubscription struct {
	*rclgo.Subscription
}

// AirspeedValidatedSubscriptionCallback type is used to provide a subscription
// handler function for a AirspeedValidatedSubscription.
type AirspeedValidatedSubscriptionCallback func(msg *AirspeedValidated, info *rclgo.MessageInfo, err error)

// NewAirspeedValidatedSubscription creates and returns a new subscription for the
// AirspeedValidated
func NewAirspeedValidatedSubscription(node *rclgo.Node, topic_name string, opts *rclgo.SubscriptionOptions, subscriptionCallback AirspeedValidatedSubscriptionCallback) (*AirspeedValidatedSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg AirspeedValidated
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topic_name, AirspeedValidatedTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
	return &AirspeedValidatedSubscription{sub}, nil
}

func (s *AirspeedValidatedSubscription) TakeMessage(out *AirspeedValidated) (*rclgo.MessageInfo, error) {
...
func (t _AirspeedValidatedTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	mem.airspeed_derivative_filtered = C.float(m.AirspeedDerivativeFiltered)
	mem.throttle_filtered = C.float(m.ThrottleFiltered)
	mem.pitch_filtered = C.float(m.PitchFiltered)
}
...
func (t _AirspeedValidatedTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	m.AirspeedDerivativeFiltered = float32(mem.airspeed_derivative_filtered)
	m.ThrottleFiltered = float32(mem.throttle_filtered)
	m.PitchFiltered = float32(mem.pitch_filtered)
}
...
func AirspeedValidated__Sequence_to_Go(goSlice *[]AirspeedValidated, cSlice CAirspeedValidated__Sequence) {
	...
	*goSlice = make([]AirspeedValidated, cSlice.size)
	src := unsafe.Slice(cSlice.data, cSlice.size)
	for i := range src {
		AirspeedValidatedTypeSupport.AsGoStruct(&(*goSlice)[i], unsafe.Pointer(&src[i]))
	}
}
func AirspeedValidated__Sequence_to_C(cSlice *CAirspeedValidated__Sequence, goSlice []AirspeedValidated) {
	...
	cSlice.data = (*C.px4_msgs__msg__AirspeedValidated)(C.malloc(C.sizeof_struct_px4_msgs__msg__AirspeedValidated * C.size_t(len(goSlice))))
	cSlice.capacity = C.size_t(len(goSlice))
	cSlice.size = cSlice.capacity
	dst := unsafe.Slice(cSlice.data, cSlice.size)
	for i := range goSlice {
		AirspeedValidatedTypeSupport.AsCStruct(unsafe.Pointer(&dst[i]), &goSlice[i])
	}
}
