...
func init() {
	...
	typemap.RegisterMessage("px4_msgs/msg/GimbalDeviceAttitudeStatus", GimbalDeviceAttitudeStatusTypeSupport)
}
...
type GimbalDeviceAttitudeStatus struct {
	...
	ReceivedFromMavlink bool       `yaml:"received_from_mavlink"`
}
...
func (t *GimbalDeviceAttitudeStatus) Clone() *GimbalDeviceAttitudeStatus {
	...
	c.ReceivedFromMavlink = t.ReceivedFromMavlink
	return c
}
...
func (t _GimbalDeviceAttitudeStatusTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	mem.received_from_mavlink = C.bool(m.ReceivedFromMavlink)
}
...
func (t _GimbalDeviceAttitudeStatusTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	m.ReceivedFromMavlink = bool(mem.received_from_mavlink)
}
...
func GimbalDeviceAttitudeStatus__Sequence_to_C(cSlice *CGimbalDeviceAttitudeStatus__Sequence, goSlice []GimbalDeviceAttitudeStatus) {
	...
	cSlice.data = (*C.px4_msgs__msg__GimbalDeviceAttitudeStatus)(C.malloc(C.sizeof_struct_px4_msgs__msg__GimbalDeviceAttitudeStatus * C.size_t(len(goSlice))))
