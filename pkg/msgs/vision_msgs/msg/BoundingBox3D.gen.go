...
type BoundingBox3D struct {
	Center geometry_msgs_msg.Pose    `yaml:"center"` // The 3D position and orientation of the bounding box center
	Size   geometry_msgs_msg.Vector3 `yaml:"size"`   // The total size of the bounding box, in meters, surrounding the object's centerpose.
}
