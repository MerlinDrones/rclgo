...
type LabelInfo struct {
	...
	ClassMap  []VisionClass       `yaml:"class_map"` // An array of uint16 keys and string values containing the associationbetween class identifiers and their names. According to the amountof classes and the datatype used to store their ids internally, themaxiumum class id allowed (65535 for uint16 and 255 for uint8) belongs tothe "UNLABELED" class.
	Threshold float32             `yaml:"threshold"` // The value between 0-1 used as confidence threshold for the inference.
}
