...
func init() {
	typemap.RegisterMessage("vision_msgs/Pose2D", Pose2DTypeSupport)
	typemap.RegisterMessage("vision_msgs/msg/Pose2D", Pose2DTypeSupport)
}

type Pose2D struct {
	Position Point2D `yaml:"position"`
...
func (t _Pose2DTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.vision_msgs__msg__Pose2D
	return (unsafe.Pointer)(C.vision_msgs__msg__Pose2D__create())
}

func (t _Pose2DTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.vision_msgs__msg__Pose2D__destroy((*C.vision_msgs__msg__Pose2D)(pointer_to_free))
}

func (t _Pose2DTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*Pose2D)
	mem := (*C.vision_msgs__msg__Pose2D)(dst)
	Point2DTypeSupport.AsCStruct(unsafe.Pointer(&mem.position), &m.Position)
	mem.theta = C.double(m.Theta)
}

func (t _Pose2DTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Pose2D)
	mem := (*C.vision_msgs__msg__Pose2D)(ros2_message_buffer)
	Point2DTypeSupport.AsGoStruct(&m.Position, unsafe.Pointer(&mem.position))
	m.Theta = float64(mem.theta)
}

func (t _Pose2DTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__vision_msgs__msg__Pose2D())
}

type CPose2D = C.vision_msgs__msg__Pose2D
type CPose2D__Sequence = C.vision_msgs__msg__Pose2D__Sequence
...
func Pose2D__Sequence_to_C(cSlice *CPose2D__Sequence, goSlice []Pose2D) {
	...
	cSlice.data = (*C.vision_msgs__msg__Pose2D)(C.malloc(C.sizeof_struct_vision_msgs__msg__Pose2D * C.size_t(len(goSlice))))
