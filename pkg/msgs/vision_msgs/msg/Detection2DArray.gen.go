...
type Detection2DArray struct {
	...
	Detections []Detection2D       `yaml:"detections"` // A list of the detected proposals. A multi-proposal detector might generatethis list with many candidate detections generated from a single input.
}
