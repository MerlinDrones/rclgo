...
type Classification struct {
	...
	Results []ObjectHypothesis  `yaml:"results"` // A list of class probabilities. This list need not provide a probability forevery possible class, just ones that are nonzero, or above someuser-defined threshold.
}
