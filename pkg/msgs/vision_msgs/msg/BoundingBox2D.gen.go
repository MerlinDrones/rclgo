...
type BoundingBox2D struct {
	Center Pose2D  `yaml:"center"` // The 2D position (in pixels) and orientation of the bounding box center.
	SizeX  float64 `yaml:"size_x"` // The total size (in pixels) of the bounding box surrounding the object relativeto the pose of its center.
