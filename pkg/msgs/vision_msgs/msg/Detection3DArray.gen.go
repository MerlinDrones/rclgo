...
type Detection3DArray struct {
	...
	Detections []Detection3D       `yaml:"detections"` // A list of the detected proposals. A multi-proposal detector might generatethis list with many candidate detections generated from a single input.
}
